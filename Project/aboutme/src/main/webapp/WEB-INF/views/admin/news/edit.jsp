								...
								<div class="row">
									<div class="col-sm-6">
										<div class="form-group">
											...
											<input value = "${news.name}"  name="name" type="text" class="form-control" placeholder="Nhập tên tin">
										...
										<div class="form-group">
										   ...
										   <textarea  id ="description" name = "detail" class="form-control" rows="3">${news.detail}</textarea>
