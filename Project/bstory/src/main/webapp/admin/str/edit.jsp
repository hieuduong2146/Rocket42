...
<div id="page-wrapper">
    <div id="page-inner">
        ...
        if(str != null){
        	name = str.getName();
        	catID = String.valueOf(str.getCategory().getId());
        	priviewText = str.getPreview_text();
        	detailText	= str.getDetail_text();
        	picture = str.getPicture();
        }
    	if(err != null){
    		switch(err){
    		case "1" : 
                            ...
                            <div class="col-md-12">
                                <form role="form" enctype="multipart/form-data" method="post">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <%if(!picture.isEmpty()){ %>
        								  <img width = "200px" height="100px" src="<%=request.getContextPath() %>/files/<%=picture %>" alt="Anh" src=""/>                             
                                        <%} %>
                                    <div class="form-group">
                                        <label>Mô tả</label>
